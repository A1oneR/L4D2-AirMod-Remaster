...
public void OnPluginStart()
{
	...
	CVAR_MsgFormat = CreateConVar("sm_csc_message_format", "{lightgreen}[SERVER TAG] {olive}->{default} {lightgreen}[SENDER NAME]{default}: [MESSAGE]", "Format of the message. Use the tag [SERVER TAG] to represent the value of 'CVAR_ServerTag', [SENDER NAME] for the player name who send the message, and [MESSAGE] to represent the message of teh player.");
