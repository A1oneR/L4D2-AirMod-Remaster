...
public void OnPluginStart()
{
    ...
    C_path = CreateConVar("force_director_script_keyvalues_path", "data/force_director_script_keyvalues.cfg", "load this file");
    ...
    //AutoExecConfig(true, "force_director_script_keyvalues");
    get_all_cvars();
