...
public void OnPluginStart() {
	...
	**/
	...
	g_cvCooldown = CreateConVar("sm_emotes_cooldown", "0.0", "冷却时间以秒为单位.-1或0 =无冷却时间.", CVAR_FLAGS);
	...
	g_cvHideWeapons = CreateConVar("sm_emotes_hide_weapons", "1", "跳舞时隐藏武器(1=是0=否)", CVAR_FLAGS);
