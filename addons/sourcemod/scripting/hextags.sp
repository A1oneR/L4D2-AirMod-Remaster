...
public Action CP_OnChatMessage(int & author, ArrayList recipients, char[] flagstring, char[] name, char[] message, bool & processcolors, bool & removecolors)
{
...

	{
		...
		float sPoints;
		sPoints = GetClientRating(author);
		if (sPoints <= 0)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "UR");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "UR");
		}
		else if (sPoints > 0 && sPoints < 3)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "D5");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "D5");
		}
		else if (sPoints >= 3 && sPoints < 6)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "D4");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "D4");
		}
		else if (sPoints >= 6 && sPoints < 9)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "D3");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "D3");
		}
		else if (sPoints >= 9 && sPoints < 12)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "D2");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "D2");
		}
		else if (sPoints >= 12 && sPoints < 15)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "D1");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "D1");
		}
		else if (sPoints >= 15 && sPoints < 20)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "C5");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "C5");
		}
		else if (sPoints >= 20 && sPoints < 25)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "C4");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "C4");
		}
		else if (sPoints >= 25 && sPoints < 30)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "C3");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "C3");
		}
		else if (sPoints >= 30 && sPoints < 35)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "C2");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "C2");
		}
		else if (sPoints >= 35 && sPoints < 40)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "C1");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "C1");
		}
		else if (sPoints >= 40 && sPoints < 47)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "B5");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "B5");
		}
		else if (sPoints >= 47 && sPoints < 54)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "B4");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "B4");
		}
		else if (sPoints >= 54 && sPoints < 61)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "B3");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "B3");
		}
		else if (sPoints >= 61 && sPoints < 68)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "B2");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "B2");
		}
		else if (sPoints >= 68 && sPoints < 75)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "B1");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "B1");
		}
		else if (sPoints >= 75 && sPoints < 85)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "A5");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "A5");
		}
		else if (sPoints >= 85 && sPoints < 95)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "A4");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "A4");
		}
		else if (sPoints >= 95 && sPoints < 105)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "A3");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "A3");
		}
		else if (sPoints >= 105 && sPoints < 115)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "A2");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "A2");
		}
		else if (sPoints >= 115 && sPoints < 125)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "A1");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "A1");
		}
		else if (sPoints >= 125 && sPoints < 140)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "S3");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "S3");
		}
		else if (sPoints >= 140 && sPoints < 155)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "S2");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "S2");
		}
		else if (sPoints >= 155 && sPoints < 180)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "S1");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "S1");
		}
		else if (sPoints >= 180)
		{
			ReplaceString(sNewName, sizeof(sNewName), "{rating}", "SS");
			ReplaceString(sNewMessage, sizeof(sNewMessage), "{rating}", "SS");
		}
	}
	//Rainbow Chat
