...
float CONTROL_DELAY_SAFETY             = 3.3;
...
public void OnPluginStart()
{
	...
	cvar_SurrenderChoiceType = CreateConVar("l4d_tankswap_choicetype", "1", " 0 - Disabled; 1 - Type !tankpass Button to call Menu; 2 - Menu appears for every Tank ", FCVAR_NOTIFY);
	...
	cvar_Cost = CreateConVar("l4d_tankswap_cost", "0.9", "The percent HP the new tank will get.", FCVAR_NOTIFY);
