...
public void Event_TankSpawn(Event hEvent, char[] sEventName, bool dontBroadcast)
{
    ...
    */
    ...
    {
        CPrintToChatAll("{red}[{default}Tank回撤{red}] {default}生还者每跑回 {olive}%i{green}%% {default}的路程，Tank会获得额外 {olive}%0.1f {green}秒的喘息时间{default}", convarRageFlowPercent.IntValue, convarRageFreezeTime.FloatValue);
