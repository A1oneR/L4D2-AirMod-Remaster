...
public void OnPluginStart()
{
	...
	// Cvars
	// ====================================================================================================
	g_hCvarAllow =		CreateConVar(	"l4d2_throwable_allow",			"0",				"0=Plugin off, 1=Plugin on.", CVAR_FLAGS );
	...
	g_hCvarSpeedMax =	CreateConVar(	"l4d2_throwable_speed_max",		"1200",				"Maximum speed. How fast to throw a melee weapon, affects range.", CVAR_FLAGS);
	g_hCvarSpeedTime =	CreateConVar(	"l4d2_throwable_speed_time",	"1.5",				"0.0=Off, instant throw. Max time to get max speed. The longer players hold Zoom/Scope (MMB - middle mouse button) the faster they throw.", CVAR_FLAGS);
	...
	g_hCvarTypes =		CreateConVar(	"l4d2_throwable_types",			"8192",			"Which melee weapons can be thrown: 1=Baseball Bat, 2=Cricket Bat, 4=Crowbar, 8=Frying Pan, 16=Guitar, 32=Fireaxe, 64=Golfclub, 128=Katana, 256=Knife, 512=Machete, 1024=Tonfa, 2048=Riot Shield, 4096=Generic, 8192=Pitchfork, 16384=Shovel, 32767=All. Add numbers together.", CVAR_FLAGS);
